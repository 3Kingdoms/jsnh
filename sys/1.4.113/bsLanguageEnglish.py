...
values = {
    ...
    'showText':'Show',
    'signInForPromoCodeText':'You must sign in to an account for promo-codes to take effect.',
    'submittingPromoCodeText':'Submitting Promo Code...',
    'enjoyText':'Enjoy!',
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeWhereToEnterText':'(in "Settings->Advanced->Enter Promo Code")',
        'friendPromoCodeInstructionsText':('To use it, open ${APP_NAME} and go to "Settings->Advanced->Enter Promo Code".\n'
    ...
    'internal':{
        ...
        'hasMenuControlText':'${NAME} currently has menu control.',
    ...
    'promoSubmitErrorText':'Error submitting promo code; check your internet connection',
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'Enter Promo Code',
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('• Removes in-game ads\n'
                                          '• Also includes:'),

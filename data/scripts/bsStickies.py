...
class StickiesGame(bs.TeamGameActivity):

    #This gamemode is created by PG I. Edited by TheMikirog to make it work with Joyride Modpack.
    @classmethod
    def getName(cls):
        return 'Stickies!'
    ...
    def getDescription(cls, sessionType):
        return 'Stick bombs to enemies and blow them up!'
